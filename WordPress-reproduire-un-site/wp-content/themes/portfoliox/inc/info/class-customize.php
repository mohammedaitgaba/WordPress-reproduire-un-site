 ...
 * @access public
 */
final class portfoliox_pro_Customize
{
	...
	public function sections($manager)
	{
		...
		$manager->register_section_type('portfoliox_pro_Customize_Section_Pro');

		// Register sections.
		$manager->add_section(
			new portfoliox_pro_Customize_Section_Pro(
				$manager,
				'portfoliox_pro',
				array(
					'title'    => esc_html__('Now Available PortfolioX Pro', 'portfoliox'),
					'pro_text' => esc_html__('Go Pro', 'portfoliox'),
...
portfoliox_pro_Customize::get_instance();
