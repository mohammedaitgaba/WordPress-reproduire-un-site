...
if (!defined('PORTFOLIOX_VERSION')) {
	...
	define('PORTFOLIOX_VERSION', $portfoliox_theme->get('Version'));
}
...
function portfoliox_scripts()
{
	...
	wp_enqueue_script('portfoliox-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), PORTFOLIOX_VERSION, true);
